						...
						<table class="board-form va-m">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" id="name" name="inqurNm" class="input-text w150px" value="[회원이름]" maxlength="15"></td>
									<th scope="row"><label for="qnaRpstEmail">이메일</label> <em class="font-orange">*</em></th>
									<td><input type="text" name="rpstEmail" id="qnaRpstEmail" class="input-text" value="[회원이메일]" maxlength="50"></td>
								</tr>
								<tr>
									...
									<td colspan="3">
												...
												<input type="text" name="hpNum1" id="hpNum1" class="input-text w60px numType" value="010" maxlength="3" title="핸드폰번호 첫자리 입력">
												<span>-</span>
												<input type="text" name="hpNum2" id="hpNum2" class="input-text w70px numType" value="1234" maxlength="4" title="핸드폰번호 중간자리 입력">
												<span>-</span>
												<input type="text" name="hpNum3" id="hpNum3" class="input-text w70px numType" value="5678" maxlength="4" title="핸드폰번호 마지막자리 입력">
